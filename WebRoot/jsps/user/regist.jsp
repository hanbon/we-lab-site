...
<form action="<c:url value='/UserServlet'/>" method="post" id="registForm">
    ...
    <table id="tableForm">
      ...
      <tr>
        ...
        <td class="tdInput">
          <input class="inputClass" type="text" name="qq" id="qq" value="${form.qq }"/>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="tdText">年级：</td>
        <td>
          <input class="inputClass" type="text" name="grade" id="grade" value="${form.grade }"/>
        </td>
      </tr>
      <tr>
        <td class="tdText">学号：</td>
        <td>
          <input class="inputClass" type="text" name="num" id="num" value="${form.num}"/>
        </td>
      </tr>
      <tr>
